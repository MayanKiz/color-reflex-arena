...
import { Button, Eyebrow, TactileButton } from '../SharedUI';
...
export default function FullscreenScreen({ onEnter, onContinue }) {
  return (
    <section className="screen-card hero-screen fullscreen-screen">
      ...
      <TactileButton className="tactile-button-continue" depth="shallow" type="button" onClick={onContinue}>Continue in window <ArrowRight size={14} /></TactileButton>
    </section>
  );
}
